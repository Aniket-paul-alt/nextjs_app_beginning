...
export default function DataFetchClient() {
  ...
  if(!infoData.name) return null

  const isMale = infoData.gender === "male";
  const confidencePercentage = infoData.probability * 100;
        ...
        <div className="relative z-10">
          ...
          <div className="text-center mb-6">
            ...
            >
              ...
              ></span>
              {infoData.gender.charAt(0).toUpperCase() +
                infoData.gender.slice(1)}
            </div>
          </div>
